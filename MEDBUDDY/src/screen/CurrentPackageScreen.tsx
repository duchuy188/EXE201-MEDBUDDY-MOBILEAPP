...
const CurrentPackageScreen = ({ navigation }: any) => {
  ...
  const fetchCurrentPackage = async () => {
    try {
      ...
      const response = await userPackageService.getMyActivePackage(token);
        ...
        >
          ...
          <View style={styles.actionsContainer}>
            ...
            >
              ...
              <Text style={styles.actionButtonText}>Lịch sử thanh toán</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      )}
...
export default CurrentPackageScreen;